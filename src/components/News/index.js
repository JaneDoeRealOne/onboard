        ...
        <Carousel breakPoints={breakPoints}>
          <Item className="backgroundImage backgroundColor">
            ...
            <a
              className="button"
              target='_blank'
              href={'https://kyh.se/inspiration/nu-kor-jag-jag-har-inget-att-forlora/'}
          ...
          <Item className="backgroundImage">
            ...
            <a
              className="button"
              target='_blank'
              href={'https://kyh.se/inspiration/utbildningsledare-med-it-kompetens-sokes-i-malmo/'} rel='noopener noreferrer'
            >Information</a>
          </Item>
          <Item className="backgroundImage">
            <p>2021-03-09</p>
            ...
            <a
              className="button"
              target='_blank'
              href={'https://kyh.se/inspiration/jag-vill-vara-ute-pa-plats-med-platsledningen-och-sta-i-betongen/'}
              rel='noopener noreferrer'
            >Intervjuer</a>
          </Item>
          <Item className="backgroundImage">
            ...
            <a
              className="button"
              target='_blank'
              href={'https://kyh.se/inspiration/det-ar-intressant-att-kunna-gora-nagot-sa-har-mitt-i-livet/'}
              rel='noopener noreferrer'
            >Intervjuer</a>
          </Item>
          <Item className="backgroundImage">
            ...
            <a
              className="button"
              target='_blank'
              href={'https://kyh.se/inspiration/karriar-och-studiesamordnare-i-malmo-sokes/'}
              rel='noopener noreferrer'
            >Information</a>
          </Item>
        </Carousel>
